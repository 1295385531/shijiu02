...
public class 普通用户登入界面 extends JFrame {
...
ResultSet rs =null;
	...
	public 普通用户登入界面() {
		...
		button.addActionListener(new ActionListener() {
			...
			{
				jdbc1 DB=  new jdbc1();
				String sql = "select * from useradmin where username ='" + txtuser.getText().toString() +"' and password = '" + txtpassword.getText().toString()+"'";
			try {DB.OpenConn();
